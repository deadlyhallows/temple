...
def notifications(request):
    ...
    """
    user = request.user
    notification_list = Notification.objects.filter(recipient_id=request.user.id)
    context = {
...
def mark_all(request):
    ...
    #return redirect('notifications:all',ctx)
    #return render(request, 'notifications/all.html',ctx)
